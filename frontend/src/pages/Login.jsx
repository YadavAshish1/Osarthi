    ...
    >
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-slate-950 px-3 text-slate-500">Or with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full rounded-xl border border-white/10 bg-slate-900/80 py-3 pl-11 pr-4 outline-none focus:border-brand-500/50 focus:ring-2 focus:ring-brand-500/20"
            />
          </div>
        </div>
        ...
        <button
          type="submit"
          disabled={submitting}
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-600 py-3.5 font-semibold hover:bg-brand-500 disabled:opacity-50"
        >
      ...
      <p className="mt-8 text-center text-sm text-slate-400">
        New here?{' '}
        <Link to="/get-started" className="font-medium text-brand-400 hover:underline">
          Get started
        </Link>
      </p>
    </motion.div>
